Feature: Cancel guarantee
  ...
  Scenario: Manually rejected guarantee
    ...
    And Guarantee is created with values
      ...
      | 0001       | To be rejected manually | Address | City | Zip | 114000         | today - 2 months | today - 2 months + 5 years | False      | Red Panther  | Green Slate      | Maintenance Type |
  ...
  Scenario: Rejected guarantee
    And Guarantee is created with values
      | unitNumber | beneficiaryName | address | city | zip | contractAmount | startDate        | endDate                    | approveNow | contractName | organisationName | guaranteeType    |
      | 0003       | To be rejected  | Address | City | Zip | 114000         | today - 2 months | today - 2 months + 5 years | False      | Red Panther  | Green Slate      | Maintenance Type |
    And Guarantee status is draft
  ...
  Scenario: Cancelled guarantee
    And Guarantee is created with values
      | unitNumber | beneficiaryName | address        | city    | zip  | contractAmount | startDate | endDate          | approveNow | contractName | organisationName | guaranteeType    |
      | 0002       | To be cancelled | Prinsensgate 1 | Andenes | 8480 | 114000         | today     | today + 250 days | False      | Red Panther  | Green Slate      | Maintenance Type |
    And Guarantee status is draft
